...
const Component: FC<TIconProps> = ({height = 17.4, width = 17.4, color = '#8692A7', ...props}) => (
    <>
        <svg
            width={width}
            height={height}
