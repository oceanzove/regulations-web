...
import {CONVERT_HTML_TO_MESSAGE, GET_DECORATOR} from "../../../../text-editor/editor-utils.ts";
import {SectionBlock} from "../../../../text-editor/style-control/custom-block/section-block/section-block.tsx";
import {TEXT_EDITOR_CUSTOM_STYLES} from "../../../../text-editor";
...
const ViewerComponent: FC<ITextViewerProps> = (props: ITextViewerProps) => {
